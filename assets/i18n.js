  ...
  const translations = {
    en: {
      ...
      home: {
        ...
        locationReceptionBody: 'The reception will begin at 5:30pm. Cocktail hour, dinner reception, cake cutting, and the send off will take place here.',
    ...
    es: {
      ...
      home: {
        ...
        locationReceptionBody: 'La recepcion comenzara a las 5:30pm. Aqui se llevaran a cabo el coctel, la cena, el corte del pastel y la despedida.',
        ...
        timelinePhotosBody: 'Fotos con la familia, los amigos y los recien casados.',
        ...
        faq2Answer: 'Por favor revisen la cantidad de invitados, incluidos los ninos, que aparece en su invitacion.',
        ...
        faq4Answer: 'La misa se celebrara en ingles y espanol por un sacerdote bilingue.',
      ...
      liturgy: {
        eyebrow: '29 de mayo de 2027 · Aguascalientes, Mexico',
        heading: 'Liturgia de la misa nupcial',
        intro: 'Esperamos orar y celebrar con ustedes. Las lecturas y la seleccion de musica se compartiran aqui cuando esten confirmadas.',
        orderHeading: 'Orden de la misa',
        introRitesHeading: 'Ritos iniciales',
        introRitesItems: 'Procesion de entrada|Saludo y senal de la cruz|Acto penitencial|Gloria|Oracion colecta',
        ...
        homilyLabel: 'Homilia',
        prayerLabel: 'Oracion universal',
        marriageHeading: 'Rito del matrimonio',
        marriageItems: 'Preguntas antes del consentimiento|Intercambio de consentimiento|Bendicion y entrega de anillos|Oracion de los fieles',
        eucharistHeading: 'Liturgia de la eucaristia',
        eucharistItems: 'Presentacion de las ofrendas|Plegaria eucaristica|Padre nuestro|Bendicion nupcial|Rito de la paz|Sagrada comunion',
        concludingHeading: 'Ritos de conclusion',
        concludingItems: 'Bendicion final|Procesion de salida',
        readingsNote: 'Las lecturas completas, las respuestas del salmo y la seleccion de musica se agregaran aqui pronto.',
